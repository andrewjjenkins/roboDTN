...
import net.robodtn.cla.UdpConvergenceLayer;
import net.robodtn.test.BpAcquisitionStreamTest.AcquisitionTestPair;
...
public class UdpConvergenceLayerTest extends ServiceTestCase<UdpConvergenceLayer> {
	...
	protected void setUp() throws Exception {
		...
		mAssets = getContext().createPackageContext("net.robodtn.test", Context.CONTEXT_IGNORE_SECURITY).getAssets();
	}
